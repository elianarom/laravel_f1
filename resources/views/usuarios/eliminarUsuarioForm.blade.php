...
<x-layout>
    <x-slot:title>Confirmación para eliminar Usuario {{ $usuario->email }}</x-slot:title>
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="flex">
                                        ...
                                        <form action="{{ route('usuarios.eliminarUsuarioProceso', ['id' => $usuario->usuario_id]) }}" method="POST" class="">
                                            @csrf
