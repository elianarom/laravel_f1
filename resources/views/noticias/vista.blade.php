            ...
            <nav class="flex ml-20" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li class="inline-flex items-center text-red-600">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center text-base font-medium text-red-600 whitespace-nowrap pl-2 pr-5">Panel /</a>
                    </li>
                    @endif
                    @endauth
                    <li>
                ...
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                    ...
                    @if ($noticia->portada != null && \Storage::exists($noticia->portada))
                        <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                            <img class="w-[48rem] max-w-full rounded-xl  shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="{{ \Storage::url($noticia->portada) }}" alt="{{ $noticia->portada_descripcion }}">
                        </div>
                    @else
                        <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                            <img class="w-[48rem] max-w-full rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="{{ url('asset/imagen-por-defecto.webp') }}" alt="imagen por defecto">
                        </div>
                    @endif
