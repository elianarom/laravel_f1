        ...
        <div class="flex flex-col lg:mx-32">
            <div class="isolate overflow-hidden bg-white px-6 py-20 lg:overflow-visible lg:px-0">
                <div
                    ...
                    <h1 class="mb-3 font-semibold text-2xl">Editar noticia: <b><i>{{ $noticia->titulo }}</h1>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('noticias.editarProceso', ['id' => $noticia->noticia_id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center justify-start gap-x-6 mb-20 ">
                            <button type="submit"
                                class="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Guardar cambios</button>
                        </div>
                    </form>
                </div>
            </div>
