            ...
            <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-12">
                ...
                <form action="{{ route('auth.loginProceso') }}" method="POST" class="mx-auto mt-16 max-w-xs sm:mt-20">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" class="block w-full max-w-xs px-4 py-2 text-sm font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none leading-relaxed" placeholder="● ● ● ● ● ● ● ● ● ●" name="password">
                    </div>
